...
jlong Java_it_alborile_mobile_textdetect_service_HydrogenTextDetector_nativeConstructor(
    JNIEnv *env,
    jclass clazz,
    jlong nativePtr) {
...
void Java_it_alborile_mobile_textdetect_service_HydrogenTextDetector_nativeDestructor(
    JNIEnv *env,
    jclass clazz,
    jlong nativePtr) {
  if (DEBUG_MODE) LOGV(__FUNCTION__);
...
void Java_it_alborile_mobile_textdetect_service_HydrogenTextDetector_nativeSetParameters(
    JNIEnv *env,
    jclass clazz,
    jlong nativePtr,
    jobject params) {
...
jlong Java_it_alborile_mobile_textdetect_service_HydrogenTextDetector_nativeGetTextAreas(
    JNIEnv *env,
    jclass clazz,
    jlong nativePtr) {
  if (DEBUG_MODE) LOGV(__FUNCTION__);
...
jfloat Java_it_alborile_mobile_textdetect_service_HydrogenTextDetector_nativeGetSkewAngle(
    JNIEnv *env,
    jclass clazz,
    jlong nativePtr) {
  if (DEBUG_MODE) LOGV(__FUNCTION__);
...
jint Java_it_alborile_mobile_textdetect_service_HydrogenTextDetector_nativeGetSourceWidth(
    JNIEnv *env,
    jclass clazz,
    jlong nativePtr) {
  if (DEBUG_MODE) LOGV(__FUNCTION__);
...
jint Java_it_alborile_mobile_textdetect_service_HydrogenTextDetector_nativeGetSourceHeight(
    JNIEnv *env,
    jclass clazz,
    jlong nativePtr) {
  //LOGV(__FUNCTION__);
...
jfloatArray Java_it_alborile_mobile_textdetect_service_HydrogenTextDetector_nativeGetTextConfs(
    JNIEnv *env,
    jclass clazz,
    jlong nativePtr) {
  if (DEBUG_MODE) LOGV(__FUNCTION__);
...
jlong Java_it_alborile_mobile_textdetect_service_HydrogenTextDetector_nativeGetSourceImage(
    JNIEnv *env,
    jclass clazz,
    jlong nativePtr) {
  if (DEBUG_MODE) LOGV(__FUNCTION__);
...
void Java_it_alborile_mobile_textdetect_service_HydrogenTextDetector_nativeSetSourceImage(
    JNIEnv *env,
    jclass clazz,
    jlong nativePtr,
    jlong nativePix) {
...
void Java_it_alborile_mobile_textdetect_service_HydrogenTextDetector_nativeDetectText(
    JNIEnv *env,
    jclass clazz,
    jlong nativePtr) {
  if (DEBUG_MODE) LOGV(__FUNCTION__);
...
void Java_it_alborile_mobile_textdetect_service_HydrogenTextDetector_nativeClear(
    JNIEnv *env,
    jclass clazz,
    jlong nativePtr) {
  if (DEBUG_MODE) LOGV(__FUNCTION__);
