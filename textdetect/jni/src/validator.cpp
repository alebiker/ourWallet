...
/**
 * Compute the confidance of a single box based on some geometry characteristics weigthed apriori
 */
...
/**
 * Validation of a single component with filtering based on geometry parameters
 */
bool ValidateSingleton(PIX *pix, BOX *box, PIX *pix8, l_float32 *pconf,
  ...
  *pconf = 0.0;
  ...
  //*pconf = 1.0;
  *pconf = ComputeSingletonConfidence(pix, box, pix8);
