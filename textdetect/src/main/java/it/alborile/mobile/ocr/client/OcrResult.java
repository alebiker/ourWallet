...
public class OcrResult implements Parcelable {
    ...
    public static final Creator<it.alborile.mobile.ocr.client.OcrResult> CREATOR = new Creator<it.alborile.mobile.ocr.client.OcrResult>() {
        @Override
        public it.alborile.mobile.ocr.client.OcrResult createFromParcel(Parcel in) {
            return new it.alborile.mobile.ocr.client.OcrResult(in);
        }

        @Override
        public it.alborile.mobile.ocr.client.OcrResult[] newArray(int size) {
            return new it.alborile.mobile.ocr.client.OcrResult[size];
        }
    };
