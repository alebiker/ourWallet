...
public class Language implements Comparable<Language>, Parcelable {
    ...
    @Override
    public int compareTo(it.alborile.mobile.ocr.client.Language another) {
    ...
    public static final Creator<it.alborile.mobile.ocr.client.Language> CREATOR = new Creator<it.alborile.mobile.ocr.client.Language>() {
        @Override
        public it.alborile.mobile.ocr.client.Language createFromParcel(Parcel in) {
            return new it.alborile.mobile.ocr.client.Language(in);
        }

        @Override
        public it.alborile.mobile.ocr.client.Language[] newArray(int size) {
            return new it.alborile.mobile.ocr.client.Language[size];
        }
    };
}
