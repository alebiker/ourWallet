...
public class HydrogenTextDetector {
    ...
    public static class Parameters {
        ...
        /** reduce the min valid cluster aspect ratio bw wight / height
        // reduce the minimum number components that compose a valid cluster */
        public void setNumDetectionMode(boolean numDetectionMode) {
            if(numDetectionMode){
                cluster_min_blobs = 2;
                cluster_min_aspect = 0.75f;
            }else{
                cluster_min_blobs = 5;
                cluster_min_aspect = 2;
            }
        ...
        /** Reduce the min height of a valid cluster */
        public void setSmallMode(boolean smallMode) {
            if(smallMode){
                cluster_min_height = 10;
            }else{
                cluster_min_height = 15;
            }
        }
