...
public final class Intents {
    ...
    public static final class Actions {
        ...
        public static final String LANGUAGES_UPDATED =
                "it.alborile.mobile.ocr.action.LANGUAGES_UPDATED";
    ...
    public static final class Service {
         ...
         * by the Ocr object.
         */
        public static final String ACTION_OCR = "it.alborile.mobile.ocr.intent.ACTION_OCR";
        public static final String ACTION_TEXT_DETECTION = "it.alborile.mobile.textdetect.intent.ACTION_TEXT_DETECTION";
        public static final String CATEGORY = Intent.CATEGORY_DEFAULT;
        public static final String PACKAGE = "it.alborile.mobile.ocr";
    ...
    public static final class Languages {
         ...
         * by the Ocr object.
         */
        public static final String ACTION = "it.alborile.mobile.ocr.intent.LANGUAGES";
    ...
    public static final class Detect extends BaseCapture {
         ...
         */
        public static final String ACTION = "it.alborile.mobile.ocr.intent.DETECT";
    ...
    protected static class OCRBaseRecognize {
        /**
         ...
         */
        public static final String EXTRA_RECTS = "results";

        private OCRBaseRecognize() {
            // This class is not instantiable.
        }
    }

    public static final class Recognize extends OCRBaseRecognize {
        /**
         * Send this intent to process an OCR configuration object and receive
         * OCR results in return.
         */
        public static final String ACTION = "it.abapp.mobile.shoppingtogether.intent.RECOGNIZE";
